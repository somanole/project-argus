    ...
    <template v-if="showShell">
      ...
      <aside class="sidebar" :class="{ collapsed, open: drawerOpen }">
        ...
        <nav class="nav" aria-label="Primary">
          ...
          <router-link class="nav-item" to="/workflows" :title="collapsed ? 'Catalog' : undefined">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="4.5" width="18" height="4" rx="1" /><rect x="3" y="10" width="18" height="4" rx="1" /><rect x="3" y="15.5" width="18" height="4" rx="1" /></svg><span class="lbl">Catalog</span>
          </router-link>
          <router-link class="nav-item" to="/health" :title="collapsed ? 'Health' : undefined">
          ...
          <router-link class="nav-item" to="/graph" :title="collapsed ? 'Graph' : undefined">
          ...
          <router-link class="nav-item" to="/governance" :title="collapsed ? 'Governance' : undefined">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"><path d="M12 3l7 3v5c0 4.6-3 7.6-7 9-4-1.4-7-4.4-7-9V6z" /></svg><span class="lbl">Governance</span>
          </router-link>
...
.nav-item.router-link-active { color: var(--background--brand); background: var(--background--subtle); opacity: 1; }
.nav-sec {
